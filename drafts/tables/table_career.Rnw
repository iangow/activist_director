...
controls <- c("factor(year)", "factor(sic2)",
              "age", "female", "tenure_calc", "comp_committee", "audit_committee",
...
\caption{Career consequences for activist directors: Other directorships}
...
stargazer(fm.t4.c1, fm.t4.c2, fm.t4.c5, fm.t4.c6,
          ...
          column.labels =  c("All dir.", "New dir.", "Activism", "Act. demand"),
          dep.var.caption = "",
          dep.var.labels.include = FALSE, # "$\\textit{Other Boards}_{t+2}$",
          float=FALSE, align=TRUE, font.size="small",
          keep.stat=c("n"), no.space=TRUE,
          covariate.labels = c("Other boards", "Affiliated director", "Unaffiliated director", "Age", "Female",
