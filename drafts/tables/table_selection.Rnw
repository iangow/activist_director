...
prob_activist_director <- dbGetQuery(pg, "
    ...
    activism_events AS (
        SELECT DISTINCT a.permno, a.eff_announce_date,
            ...
            'Hedge Fund Company' = ANY(holder_types) AS hedge_fund,
...
<<<<<<< HEAD
    -- Matched with activism events (datadate BETWEEN eff_announce_date - 1 year AND eff_announce_date)
=======
    -- Matched with activism events
    -- (datadate BETWEEN eff_announce_date - 1 year AND eff_announce_date)
>>>>>>> 03440684fc2b1cc2258280c1e57e44ae0a309d61
    SELECT DISTINCT a.permno, a.datadate, a.fyear,
        ...
        dissident_group_ownership_percent,
        demanding_activist, hedge_fund, b.big_investment,
...
>>>>>>> 03440684fc2b1cc2258280c1e57e44ae0a309d61
    ...
    BETWEEN b.eff_announce_date - interval '1 year' AND b.eff_announce_date
...
<<<<<<< HEAD
reg.data <- subset(prob_activist_director, on_boardex)
=======
...
# Subset on activism
reg.data <- subset(prob_activist_director, on_boardex & !is.na(category))
t3.pb <- list()
