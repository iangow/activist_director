...
@
  ...
  {\small
This tablepresents results from logit regressions where the dependent variables are indicators for activists demanding a board seat (\textit{Board demand}, Column 1), activists getting a board seat (\textit{Activist director}, Column 2), activists getting a board seat where the director is not affiliated with the activist (\textit{Unaffiliated director}, Column 3), and activists getting a board seat where the director is affiliated with the activist (\textit{Affiliated director}, Column 4), conditional on the firm being targeted by activists.
