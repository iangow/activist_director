...
Multiple demands can be made for each activism event. Demand over Success reports the probability of activist demand being met by the boards successfully.
  \newline}
%  \end{flushleft}
  \end{minipage}
...
demand_labels <- tribble(
  ...
  "block_merger", "Block merger",
  "remove_defense", "Remove defense",
  "acquisition", "Acquisition",
  "leverage", "Leverage",
  "add_indep", "Add ind. dir.",
  "remove_director", "Remove director",
  "remove_officer", "Remove officer",
  "esg", "ESG",
  "block_acquisition", "Block acquisition",
  "reits", "REITs")
