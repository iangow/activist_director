...
WITH firm_years AS (
    ...
    SELECT DISTINCT a.permno, a.datadate, a.fyear,
        COALESCE(a.category, '_none') AS category,
        COALESCE(a.activism, FALSE) AS activism,
        COALESCE(a.activist_demand, FALSE) AS activist_demand,
        COALESCE(a.activist_director, FALSE) AS activist_director,
    ...
    LEFT JOIN activist_director.outcome_controls AS b
