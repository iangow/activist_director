...
All regressions include industry and year fixed effects and controls measured for the prior fiscal year-end (See Section 3.5 for definitions).
...
%     \textit{Payout} the ratio of the sum of dividends and repurchases to EBITDA);
