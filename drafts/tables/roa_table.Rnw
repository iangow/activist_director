...
sw_ad_roa_ffe <- plm(roa ~ year_m3 + year_m2 + year_m1 + year_p0 + year_p1 + year_p2 + year_p3 + year_p4 + year_p5
                            + year_ad_m3 + year_ad_m2 + year_ad_m1 + year_ad_p0 + year_ad_p1 + year_ad_p2 + year_ad_p3 + year_ad_p4 + year_ad_p5
                            + mv + age,
                    data=sw, index=c("permno", "fyear"), model="within")
...
\end{minipage}
\small
\begin{tabular}{l D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3} D{.}{.}{-3}}
...
\hline
 & \multicolumn{1}{c}{\textrm{Activism}} & \multicolumn{1}{c}{\textrm{Activism}} &
    ...
    \multicolumn{1}{c}{\textrm{Activism}} & \multicolumn{1}{c}{\textrm{Affiliated director}} & \multicolumn{1}{c}{\textrm{Unaffiliated director}}\\
<<table_roa_f_table, dependson=c("table_roa_est", "make_rows"), results='asis'>>=
sw_f <- cbind(sw_roa.f, sw_roa_ffe.f, sw_ad_roa_ffe.f, sw_aff_roa_ffe.f) #sw_roa_nad_ffe.f, sw_roa_ad_ffe.f)
...
\hline
\newline
\textrm{Model:} & \multicolumn{1}{c}{(A)} & \multicolumn{1}{c}{(B)} & \multicolumn{1}{c}{(C)} & \multicolumn{1}{c}{(C)} & \multicolumn{1}{c}{(D)} & \multicolumn{1}{c}{(D)} & \multicolumn{1}{c}{(D)}\\
\textrm{Fixed effects:} & \multicolumn{1}{c}{\textrm{Industry, year}} & \multicolumn{1}{c}{\textrm{Firm, year}} & \multicolumn{1}{c}{\textrm{Firm, year}} & \multicolumn{1}{c}{\textrm{Firm, year}} & \multicolumn{1}{c}{\textrm{Firm, year}} & \multicolumn{1}{c}{\textrm{Firm, year}} & \multicolumn{1}{c}{\textrm{Firm, year}}\\
\newline
\end{tabular}
\small
%\newpage
...
\hline
<<table_roa_n_table, dependson=c("table_roa_est", "make_rows"), results='asis'>>=
# Observations
sw_n <- as.data.frame(
    rbind(
