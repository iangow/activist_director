...
survival_data_by_demand <-
    ...
    mutate(across(strategy_outcome:esg_outcome, ~ coalesce(., FALSE)),
...
row.names(panel3) <- c("Intercept", "", "Affiliated director", " ", "Unaffiliated director", "  ",
                       "Success", "   ",
                       "Affiliated $\\times$ Success", "    ", "Unaffiliated $\\times$ Success", "     ")
...
row.names(panel4) <- c("Other activism $\\times$ Not success", "Other activism $\\times$ Success",
                       "Affiliated director $\\times$ Not success", "Affiliated director $\\times$ Success",
                       "Unaffiliated director $\\times$ Not success", "Unaffiliated director $\\times$ Success")
@
\begin{table}[htb]
  \caption{Activist holding periods}
