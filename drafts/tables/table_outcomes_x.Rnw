...
t.pa <- list()
rhs.1 <- c("affiliated*block_merger_demand", controls)
rhs.1 <- paste0(paste(rhs.1, collapse = " + "), " - block_merger_demand")
...
rhs.2 <- c("affiliated*block_acquisition_demand", controls)
rhs.2 <- paste0(paste(rhs.2, collapse = " + "), " - block_acquisition_demand")
...
stargazer(t.pa,
          ...
          column.labels = c("Acquisition",
                             ...
                             "Acquisition",
                             "Divestiture"),
          omit = c(controls, "affiliated_none"),
          covariate.labels = c(
              "Affiliated director",
