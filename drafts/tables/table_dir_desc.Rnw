...
Panel A presents data on directors (matched to Equilar) with \textit{Activist directors} relating to activist directors in the first year on their respective boards.
$N$ refers to the number of observations.
\textit{Age} refers to mean age of directors.
Values for \textit{Female}, \textit{Comm.}, \textit{Comp comm.}, \textit{Audit comm.}, \textit{Fin. expert}, and \textit{Ind. exp.} are means of indicator variables for being female, being a member of at least one board committee, being a member of the compensation committee, being a member of the audit committee, being designated a financial expert of the audit committee, and having served on another board in the same industry, respectively.
Values for \textit{Other boards}, \textit{Board exp.}, \textit{Avg. tenure}, and \textit{Total tenure} refer to means of the number of other boards served at the time, the number of other boards served prior to appointment, the average number of years a director served in other boards, and the total number of years a director served in other boards.
...
\tabularnewline
{\small
This table presents data on director skill sets.
Panel A presents data on activist director skill sets with activist directors in Column 1 and data from \citet{Adams:2018vf} in Column 2.
The difference between our activist director sample and the \citet{Adams:2018vf} sample is reported in Column 3 and its $p$-value is reported in Column 4.
\newline}
% \end{flushleft}
\end{minipage}
...
{\small
This table presents data on director skill sets.
Panel B presents data on activist director skill sets with affiliated directors in Column 2 and unaffiliated directors in Column 3.
The difference between affiliated and unaffiliated directors is reported in Column 4 and its $p$-value is reported in Column 5.
\newline}
% \end{flushleft}
\end{minipage}
\begin{tabularx}{\linewidth}{l*{6}{Y}}
