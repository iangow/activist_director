...
colnames(skill_summ_sim) <- c("Activist director", "Adams 2018", "Diff.", "Diff.(%)", "P-value")
@
...
\begin{table}[htb]
  \caption{Director characteristics}
\begin{tabularx}{\linewidth}{l*{6}{Y}}
\multicolumn{6}{l}{Panel C: Activist director skillsets: Activist directors}
% \hline
\\
<<dir_desc_panel_C, dependson="dir_desc_table", results='asis'>>=
# Note that display has to cover rownames as well (I set this to "s")
print(xtable(skill_summ_sim, display=c("s", "f", "f", "f", "f", "f")),
