...
Panel A presents data on activist director skill sets with the percentage of activist directors with the \textit{skill} in Column 1 (\textit{Activist director}) and the percentage of directors with the \textit{skill} using data from \citet{Adams:2018vf} in Column 2 (\textit{Adams et al. (2018)}).
...
{\small
This table presents data on director skill sets.
Panel B presents data on activist director skill sets for affiliated and unaffiliated directors. Column 1 (\textit{Activist director}) refers to the percentage of activist directors with the \textit{skill}, Column 2 (\textit{Affiliated}) refers to the percentage of directors affiliated with an activist with the \textit{skill}, and Column 3 (\textit{Unaffiliated}) refers to the percentage of activist directors with no affiliation to an activist with the \textit{skill}.
