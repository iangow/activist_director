    ...
    rhs.labels <-
        switch(rhs,
           ...
           "affiliated" = if (any(grepl("_appt", lhs)))
                            c("Affiliated director", "Unaffiliated director") else
                            c("Other activism", "Affiliated director", "Unaffiliated director"),
           ...
           "early" = if (any(grepl("_appt", lhs)))
                        ...
                        c("Other activism", "Early appointment", "Late appointment"),
            "big_investment" = if (any(grepl("_appt", lhs)))
                                c("Invest. $>$ \\$100m", "Invest. $<$ \\$100m") else
                                c("Other activism", "Invest. $>$ \\$100m", "Invest. $<$ \\$100m"),
