...
caption <- "Panel B: Long-term returns around announcement of activism."
lhs.vars <- c("ret_annc_m12p0_sz", "ret_annc_m0p12_sz", "ret_annc_m0p24_sz")
out.table(reg.data, lhs.vars, rhs=rhs, caption, label=TRUE, ff=FALSE)
@

<<returns_panel_c, dependson=c("return_data_prep", "return_functions"), results='asis'>>=
caption <- "Panel C: Days $-1$ to $+1$ around announcement of settlement."
...
caption <- "Panel D: Days $-1$ to $+1$ around announcement of appointment."
...
caption <- "Panel E: Long-term returns around announcement of appointment."
