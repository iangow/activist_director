...
<<table_desc_data, eval=TRUE, message=FALSE, echo=FALSE, results='asis'>>=
library(RPostgreSQL)
...
\end{minipage}
  ...
  \hline
<<table_desc_output, dependson="table_desc_data", message=FALSE, echo=FALSE, results='asis'>>=
...
\begin{tabularx}{\linewidth}{l*{8}{Y}}
 \hline
<<Table_1c_output, dependson="table_desc_data", message=FALSE, echo=FALSE, results='asis'>>=
