...
Regressions include the lagged dependent variable, industry and year fixed effects, and controls are as described in Section 3; coefficients omitted for space.
