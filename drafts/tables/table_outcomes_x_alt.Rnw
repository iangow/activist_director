...
outcome_controls_mod <-
    ...
    mutate(default_p2 = if_else(firm_exists_p2, FALSE, NA),
           ...
           eff_announce_date = coalesce(datadate,
                                        first_appointment_date,
                                        eff_announce_date,
                                        datadate),
           eff_announce_date_p2 = sql("eff_announce_date + interval '2 years'"),
           eff_announce_date_p3 = sql("eff_announce_date + interval '3 years'")) %>%
    select(permno, first_appointment_date,
           matches("^(datadate|default_|firm_exists_|eff_announce_date)"))
...
divestiture_count <-
    ...
    mutate(divest_p2 = between(announcedate, eff_announce_date,
                               eff_announce_date_p2),
           divest_p3 = between(announcedate, eff_announce_date,
                               eff_announce_date_p3)) %>%
...
acquisition_count <-
    ...
    mutate(acquisition_p2 = between(announcedate, eff_announce_date,
                                    eff_announce_date_p2),
           acquisition_p3 = between(announcedate, eff_announce_date,
                                    eff_announce_date_p3)) %>%
    group_by(permno, datadate) %>%
...
spinoff_count <-
    ...
    mutate(spinoff_p2 = between(announcedate, eff_announce_date,
                                eff_announce_date_p2),
           spinoff_p3 = between(announcedate, eff_announce_date,
                                eff_announce_date_p3)) %>%
    group_by(permno, datadate) %>%
...
delisting_data <-
    ...
    mutate(delist_p2 = delist & between(dlstdt, eff_announce_date, eff_announce_date_p2),
           delist_p3 = delist & between(dlstdt, eff_announce_date, eff_announce_date_p3),
           merger_p2 = merger & between(dlstdt, eff_announce_date, eff_announce_date_p2),
           merger_p3 = merger & between(dlstdt, eff_announce_date, eff_announce_date_p3),
           failure_p2 = failure & between(dlstdt, eff_announce_date, eff_announce_date_p2),
           failure_p3 = failure & between(dlstdt, eff_announce_date, eff_announce_date_p3)) %>%
    group_by(permno, datadate) %>%
