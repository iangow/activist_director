...
The first measure of impact that we consider is the success rate of activist demands.
...
Examining the first column, the estimated coefficients on \textit{Activist director} and \textit{Other activism} are $-0.065$ and $-0.039$, respectively, suggesting that activism and activist directors are associated with fewer acquisitions, even in the absence of explicit demands for firms to curtail acquisitions.
...
Considering that the average rate of divestiture is 20.4\% for all firms, the likelihood of divestiture is 2.5 times higher for these firms with an activist director and a demand to block acquisitions.
...
Again, we find that activism and activist directors are generally associated with divestitures (coefs. of $0.045$ and $0.081$ for \textit{Activist director} and \textit{Other activism}, respectively).
...
However, we find no evidence of an effect of \textit{Remove (officer) demand} in any category of activism.
...
The coefficient on \textit{Affiliated director} is significantly different from those on \textit{Unaffiliated director} and \textit{Other activism}, which suggests that the appointment of an affiliated director is effective in increasing payout.
...
This is consistent with activists seeking to reduce payout even in the absence of explicit payout demands, and the appointment of affiliated directors being effective in achieving that goal.
However, payout demands may be more important when the activist does not have  representation on the board (i.e., \textit{Other activism}) or when the activist director is not an employee or principal of the activist group (i.e., \textit{Unaffiliated director}).
