...
Lastly, we find positive abnormal returns of 1\% when an activist director is appointed and up to 1 3.2\%-point increase in return on assets over the subsequent five years.
\end{abstract}
\doublespacing
...
This understanding helps us assess the effectiveness of activist directors in achieving not only the initial goals of activists, but also any hidden goals or additional goals potentially developed after their appointment.
