...
\singlespacing
\begin{abstract}
This paper examines the determinants and consequences of hedge fund activism with a focus on activist directors, i.e., those directors appointed in response to demands by activists. Using a sample of \Sexpr{num_events} activism events over the period 2004--2016, we identify \Sexpr{dirs$all_dirs} activist directors. We find that activists are more likely to gain board seats at smaller firms and those with weaker stock price performance.
