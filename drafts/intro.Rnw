...
With regard to the next set of questions, our findings show that, consistent with prior research, activists tend to target firms with relatively poor recent stock performance and ``value'' firms, i.e., those with low market-to-book ratios.
