...
\author{Ian D. Gow\thanks{Ian D. Gow and Suraj Srinivasan are at Harvard Business School. Sa-Pyung Sean Shin is at Singapore Management Univeresity.
We thank the Division of Research at Harvard Business School for financial support and participants in the HBS Accounting and Management brown bag seminar, the HBS IMO conference, and the Kellogg Accounting Research conference for helpful suggestions. Stephanie Kreutz and Kristen Garner provided excellent research support.} \and Sa-Pyung Sean Shin\footnotemark[1] \and Suraj Srinivasan\footnotemark[1]}
...
\singlespacing
\begin{abstract}
This paper examines the determinants and consequences of hedge fund activism with a focus on activist directors, i.e., those directors appointed in response to demands by activists. Using a sample of \Sexpr{num_events} activism events over the period 2004--2015, we identify \Sexpr{dirs$all_dirs} activist directors. We find that activists are more likely to gain board seats at smaller firms and those with weaker stock price performance.
