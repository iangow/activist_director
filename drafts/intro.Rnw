...
\singlespacing
\begin{abstract}
This paper examines the determinants and consequences of hedge fund activism with a focus on activist directors, i.e., those directors appointed in response to demands by activists. Using a sample of \Sexpr{num_events} activism events over the period 2004--2016, we identify \Sexpr{prettyNum(dirs$all_dirs, big.mark=",")} activist directors. We find that activists are more likely to gain board seats at smaller firms and those with weaker stock price performance.
...
We also find some evidence of a positive market reaction at the appointment of activist directors. Looking beyond positive announcement-period returns, operating performance seems to improve, with return on assets increasing by more than $1\%$ over the five years after activism.
