...
Activist-affiliated directors (i.e., employees or principals of members of the activist group) are about 10 years younger than other new directors and much less frequently female.
...
Consistent with prior research, we find significant risk-adjusted returns around the announcement of activism, with size-adjusted returns from $-20$ to $+20$ trading days around the announcement ranging from $3.9\%$ to $4.9\%$.
