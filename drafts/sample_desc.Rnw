...
For illustration, in the Blockbuster case discussed in Section \ref{sect:lit_review}, Carl Icahn is clearly an affiliated director, while the two ``veteran entertainment industry executives'' Edward Bleier and Strauss Zelnick are unaffiliated.
