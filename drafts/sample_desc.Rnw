...
While we have data on 358,193 directors, the more appropriate comparison group for activist directors, for whom we present data in their first year on the board, is their fellow new directors.
We identify 28,442 directors as new directors.
