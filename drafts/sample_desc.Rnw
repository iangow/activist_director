...
While we have data on 532,303 directors since 2004, the more appropriate comparison group for activist directors, for whom we present data in their first year on the board, is their fellow new directors.
We identify 74,642 directors as new directors.
...
In general, the unaffiliated directors are similar to other new directors on most dimensions except that there is a noticeably smaller number who are female ($0.06$ versus $0.11$).
However, affiliated directors (i.e., employees or principals of members of the activist group) appear different: they are younger (51 years of age), rarely female ($0.01$). While activist directors appear as likely to become members of the compensation committee in their first year of service ($0.31$ versus $0.31$ for directors not associated with activism campaigns), they are less frequently added to the audit committee ($0.26$), especially affiliated directors ($0.22$), than non-activism directors ($0.35$).\footnote{SEC rules require a company to disclose whether it has at least one ``audit committee financial expert'' serving on its audit committee, and if so, the name of the expert and whether the expert is independent of management. See \url{http://www.sec.gov/rules/final/33-8177.htm}.}
