...
% We find that most directors are not appointed as the result of a shareholder vote: 646 of the 824 were appointed following some kind of settlement with the incumbent board.
